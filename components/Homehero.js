  ...
  return (
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        Get the inside scoop from the people who built successful startups. We've distilled thousands of interviews into bite-sized, practical tips you can use right now. No fluff, just real strategies from founders who have been in your shoes—and made it work
    </p>
        <Logos/>
